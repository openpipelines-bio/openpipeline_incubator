...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/filter/delimit_counts/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/_private/nextflow/filter/delimit_counts",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline/filter/delimit_counts",
    "tag" : "v4.1.1"
  },
  "label" : [
    "singlecpu",
