...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/filter/filter_with_quantile/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/filter/filter_with_quantile",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline/filter/filter_with_quantile",
    "tag" : "v4.1.0"
  },
  "label" : [
    "singlecpu",
