...
meta = [
  ...
  "authors" : [
    {
      ...
      "info" : {
        "role" : "Contributor",
        "links" : {
          "email" : "hannes@data-intuitive.com"
        },
        "organizations" : [
          {
            "name" : "Data Intuitive",
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--celltype_key",
          "description" : "Column name in input_sc.obs that contains cell type annotations.\n",
          "example" : [
            "Cell_type"
          ],
          "required" : true,
        ...
        },
        {
          "type" : "string",
          "name" : "--bulk_group",
          "description" : "Optional sample grouping information for averaging bulk replicates.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "Maximum number of reference cells retained for model fitting.\n",
          "default" : [
            5000
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--top_marker_num",
          "description" : "Number of marker genes per cell type used by downstream preparation.\n",
          "default" : [
            500
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--ratio_num",
          "description" : "Multiplier controlling total generated cell counts.\n",
          "default" : [
            1
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--device_type",
          "description" : "Device selector for training: \\"gpu\\" to train on CUDA device 0, or \\"cpu\\"\n(default) to force CPU.\n",
          "default" : [
            "cpu"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--batch_size",
          "description" : "Mini-batch size used during VAE training.\n",
          "default" : [
            512
          ],
          "required" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--learning_rate",
          "description" : "Learning rate used to train the VAE.\n",
          "default" : [
            1.0E-4
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--hidden_size",
          "description" : "Size of the VAE's hidden layer.\n",
          "default" : [
            256
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--epoch_num",
          "description" : "Number of epochs used to train the VAE.\n",
          "default" : [
            3500
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--patience",
          "description" : "Number of epochs without improvement before early stopping.\n",
          "default" : [
            50
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--leiden_size",
          "description" : "Minimum Leiden cluster size retained when filtering generated cells;\nsmaller clusters are dropped as likely noise.\n",
          "default" : [
            25
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Optional CSV file with the predicted cell-type fraction per bulk sample,\nas computed before training (Bulk2Single.predicted_fraction()). Skipped\nif not provided.\n",
          "example" : [
            "output_cell_fractions.csv"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
  ...
  "links" : {
    "repository" : "https://github.com/viash-hub/custom-singlecell/",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/src/components/mapping/bulk2single/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/target/_private/nextflow/components/mapping/bulk2single",
    "viash_version" : "0.9.7",
    "git_commit" : "f2003c79c43bf1182ac800aa0058b01c5d9f808b",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline_incubator"
  },
  "package_config" : {
    "name" : "custom-singlecell",
    "version" : "build_main",
    "info" : {
      "test_resources" : [
        {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-hub/custom-singlecell/components/mapping/bulk2single",
    "tag" : "build_main"
  },
  "label" : [
    "lowmem",
