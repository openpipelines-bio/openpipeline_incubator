...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--spot_key",
          "description" : "Column names in spatial_data.obs storing x/y coordinates.\nFallback for inputs where coordinates are in .obs rather than .obsm.\n",
          "default" : [
            "xcoord",
            "ycoord"
          ],
        ...
        },
        {
          "type" : "integer",
          "name" : "--spot_num",
          "description" : "Number of synthetic spots sampled from the single-cell data when\nconstructing training pairs for the mapping model.\n",
          "example" : [
            500
          ],
          "required" : true,
        ...
        },
        {
          "type" : "integer",
          "name" : "--cell_num",
          "description" : "Number of cells assigned to each synthetic training spot.\n",
          "example" : [
            10
          ],
          "required" : true,
        ...
        },
        {
          "type" : "integer",
          "name" : "--top_marker_num",
          "description" : "Number of marker genes used to train mapping model.\n",
          "default" : [
            500
          ],
          "required" : false,
        ...
        },
        {
          "type" : "boolean",
          "name" : "--marker_used",
          "description" : "Whether to restrict training features to marker genes.\n",
          "default" : [
            true
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--k",
          "description" : "Number of nearest neighbors used for mapping refinement.\n",
          "default" : [
            10
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--num_epochs",
          "description" : "Number of epochs used to train the mapping neural network.\n",
          "default" : [
            1000
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--predicted_size",
          "description" : "Output embedding size of the model's prediction head.\n",
          "default" : [
            32
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--layer",
          "description" : "Use specified layer for expression values instead of .X from the modality.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--device_type",
          "description" : "Compute device selector: \\"gpu\\" to train on CUDA device 0, or \\"cpu\\"\n(default) to force CPU.\n",
          "default" : [
            "cpu"
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--obsm_output",
          "description" : ".obsm slot in the output AnnData where predicted spatial coordinates are stored.\n",
          "default" : [
            "spatial"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/src/components/mapping/single2spatial/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/target/_private/nextflow/components/mapping/single2spatial",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'spot_key': $( if [ ! -z ${VIASH_PAR_SPOT_KEY+x} ]; then echo "r'${VIASH_PAR_SPOT_KEY//\\'/\\'\\"\\'\\"r\\'}'.split(',')"; else echo None; fi ),
  'spot_num': $( if [ ! -z ${VIASH_PAR_SPOT_NUM+x} ]; then echo "int(r'${VIASH_PAR_SPOT_NUM//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'cell_num': $( if [ ! -z ${VIASH_PAR_CELL_NUM+x} ]; then echo "int(r'${VIASH_PAR_CELL_NUM//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'top_marker_num': $( if [ ! -z ${VIASH_PAR_TOP_MARKER_NUM+x} ]; then echo "int(r'${VIASH_PAR_TOP_MARKER_NUM//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'marker_used': $( if [ ! -z ${VIASH_PAR_MARKER_USED+x} ]; then echo "r'${VIASH_PAR_MARKER_USED//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'k': $( if [ ! -z ${VIASH_PAR_K+x} ]; then echo "int(r'${VIASH_PAR_K//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'predicted_size': $( if [ ! -z ${VIASH_PAR_PREDICTED_SIZE+x} ]; then echo "int(r'${VIASH_PAR_PREDICTED_SIZE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-hub/custom-singlecell/components/mapping/single2spatial",
    "tag" : "build_main"
  },
  "label" : [
    "lowmem",
