// scrublet_doublet_detection build_main
// 
...
// 
// Component authors:
//  * Dorien Roosen (maintainer, contributor)
...
meta = [
  ...
  "name" : "scrublet_doublet_detection",
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Name of the .obs column to store the boolean doublet predictions (True = predicted\ndoublet). If not provided, the predictions are not written.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        ...
        {
          "type" : "double",
          "name" : "--min_gene_variability_percent",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/src/components/qc/scrublet_doublet_detection/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'obs_name_predicted_doublets': $( if [ ! -z ${VIASH_PAR_OBS_NAME_PREDICTED_DOUBLETS+x} ]; then echo "r'${VIASH_PAR_OBS_NAME_PREDICTED_DOUBLETS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'min_gene_variability_percent': $( if [ ! -z ${VIASH_PAR_MIN_GENE_VARIABILITY_PERCENT+x} ]; then echo "float(r'${VIASH_PAR_MIN_GENE_VARIABILITY_PERCENT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-hub/custom-singlecell/components/qc/scrublet_doublet_detection",
    "tag" : "build_main"
  },
  "label" : [
    "highcpu",
