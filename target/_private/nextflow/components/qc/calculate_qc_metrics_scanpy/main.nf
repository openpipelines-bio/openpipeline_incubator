// calculate_qc_metrics_scanpy build_main
// 
...
meta = [
  ...
  "name" : "calculate_qc_metrics_scanpy",
  "namespace" : "components/qc",
  "version" : "build_main",
  "authors" : [
    {
      "name" : "Dorien Roosen",
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--layer",
          "description" : "Layer from the modality to use as input data. If not provided, the .X attribute is used.\n",
          "example" : [
            "raw_counts"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--qc_vars",
          "description" : "Keys to select boolean (containing only True or False) columns from .var. For each\ncell, the proportion and total of counts for genes flagged 'True' is calculated and\nstored as `pct_counts_<qc_var>` and `total_counts_<qc_var>` in .obs.\n",
          "example" : [
        ...
        },
        {
          "type" : "boolean",
          "name" : "--log1p",
          "description" : "Compute log1p-transformed versions of the metrics. For applicable metrics, an\nadditional `log1p_<metric>` column is added. Mirrors scanpy's `log1p` flag.\n",
          "default" : [
            true
          ],
          "required" : false,
  ...
  "description" : "Add quality control metrics to an .h5mu file using `scanpy.pp.calculate_qc_metrics`.\n\nThe metrics are added to .obs and .var of the selected modality, using scanpy's\nnative column names (e.g. `total_counts`, `n_genes_by_counts`, `pct_counts_<qc_var>`,\n`pct_counts_in_top_<n>_genes`).\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/src/components/qc/calculate_qc_metrics_scanpy/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-hub/custom-singlecell/components/qc/calculate_qc_metrics_scanpy",
    "tag" : "build_main"
  },
  "label" : [
    "singlecpu",
