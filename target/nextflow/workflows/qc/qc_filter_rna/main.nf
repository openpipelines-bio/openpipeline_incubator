...
meta = [
      ...
      "arguments" : [
        {
          ...
          "description" : "Minimum number of total counts per cell. Cells below this are flagged for removal.\n",
          "example" : [
            2500
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Maximum number of total counts per cell. Cells above this are flagged for removal.\n",
          "example" : [
            50000
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Minimum quantile of the log1p-transformed total counts. Cells below this quantile\nare flagged for removal. The quantile filter only runs when a min and/or max quantile\nis provided.\n",
          "example" : [
            0.05
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Maximum quantile of the log1p-transformed total counts. Cells above this quantile\nare flagged for removal. The quantile filter only runs when a min and/or max quantile\nis provided.\n",
          "example" : [
            0.95
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Minimum percentage of mitochondrial counts per cell. Cells below this are flagged for\nremoval.\n",
          "required" : false,
          "min" : 0,
          "max" : 100,
          "direction" : "input",
        ...
        },
        {
          ...
          "description" : "Maximum percentage of mitochondrial counts per cell. Cells above this are flagged for\nremoval.\n",
          "example" : [
            10
          ],
          "required" : false,
  ...
  "dependencies" : [
    ...
    {
      "name" : "components/qc/scrublet_doublet_detection",
      "alias" : "filter_with_scrublet",
      "repository" : {
        "type" : "local"
      }
    }
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/src/workflows/qc/qc_filter_rna/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
