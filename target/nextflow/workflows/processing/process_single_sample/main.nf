// process_single_sample build_main
// 
...
meta = [
  ...
  "name" : "process_single_sample",
  "namespace" : "workflows/processing",
  "version" : "build_main",
  "authors" : [
    {
      "name" : "Dorien Roosen",
  ...
  "argument_groups" : [
      ...
      "arguments" : [
        {
          ...
          "description" : "Directory containing the filtered output h5mu of every sample, one file per sample.\n",
          "example" : [
            "processed_h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          ...
          "description" : "Single TSV with the number of cells passing each filter stage, per sample, across\nall samples.\n",
          "example" : [
            "cell_counts.tsv"
          ],
          "must_exist" : true,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        {
          "type" : "integer",
          "name" : "--rna_max_total_counts",
          "description" : "Maximum number of total counts per cell for the RNA modality.",
          "required" : false,
          "min" : 0,
          "direction" : "input",
          "multiple" : false,
        ...
        {
          "type" : "double",
          "name" : "--rna_min_log1p_total_counts_quantile",
          "description" : "Minimum quantile of the log1p total counts for the RNA modality. Cells below this\nquantile are flagged for removal. The quantile filter only runs when a min and/or\nmax quantile is provided.\n",
          "required" : false,
          "min" : 0.0,
          "max" : 1.0,
          "direction" : "input",
        ...
        {
          "type" : "double",
          "name" : "--rna_max_log1p_total_counts_quantile",
          "description" : "Maximum quantile of the log1p total counts for the RNA modality. Cells above this\nquantile are flagged for removal. The quantile filter only runs when a min and/or\nmax quantile is provided.\n",
          "default" : [
            0.95
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Minimum percentage of mitochondrial counts per cell.",
          "required" : false,
          "min" : 0,
          "max" : 100,
          "direction" : "input",
        ...
        },
        {
          "type" : "integer",
          "name" : "--rna_top_n_vars",
          "description" : "Numbers of top genes used to calculate the cumulative proportion of counts for the\nRNA modality (scanpy's `percent_top`). For each value `n`, a `pct_counts_in_top_<n>_genes`\ncolumn is added to .obs.\n",
          "default" : [
            20
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--var_gene_names",
          "description" : ".var column with gene names used to detect mitochondrial genes instead of .var_names.\n",
          "default" : [
            "gene_symbol"
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        {
          "type" : "integer",
          "name" : "--prot_max_total_counts",
          "description" : "Maximum number of total counts per cell for the protein modality.",
          "required" : false,
          "min" : 0,
          "direction" : "input",
          "multiple" : false,
        ...
        {
          "type" : "double",
          "name" : "--prot_min_log1p_total_counts_quantile",
          "description" : "Minimum quantile of the log1p total counts for the protein modality. Cells below this\nquantile are flagged for removal. The quantile filter only runs when a min and/or\nmax quantile is provided.\n",
          "required" : false,
          "min" : 0.0,
          "max" : 1.0,
          "direction" : "input",
        ...
        {
          "type" : "double",
          "name" : "--prot_max_log1p_total_counts_quantile",
          "description" : "Maximum quantile of the log1p total counts for the protein modality. Cells above this\nquantile are flagged for removal. The quantile filter only runs when a min and/or\nmax quantile is provided.\n",
          "default" : [
            0.95
          ],
          "required" : false,
        ...
        {
          "type" : "integer",
          "name" : "--prot_top_n_vars",
          "description" : "Numbers of top genes used to calculate the cumulative proportion of counts for the\nprotein modality (scanpy's `percent_top`). For each value `n`, a\n`pct_counts_in_top_<n>_genes` column is added to .obs. Not calculated by default,\nmatching the reference protein QC.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : true,
      ...
      "arguments" : [
        {
          ...
          "description" : "Remove RNA genes expressed in fewer than this number of cells, evaluated after\ncell filtering. Gene filtering is skipped unless this is set.\n",
          "required" : false,
          "min" : 0,
          "direction" : "input",
          "multiple" : false,
      ...
      "arguments" : [
        {
          "type" : "boolean",
          "name" : "--intersect_obs",
          "description" : "Intersect the observations across modalities so that only cells passing every\nfilter in every modality are retained.\n",
          "default" : [
            true
          ],
          "required" : false,
  ...
  "description" : "Quantile-based QC and doublet filtering for single-sample multimodal (RNA + protein) data.\n\nThe input is split per modality and each modality is processed independently to compute\nQC (and, for RNA, scrublet doublet) keep-flags without subsetting. The modalities are then\nmerged back together, the keep-flags are applied, RNA genes expressed in too few cells are\nremoved, and the modalities are intersected so that only cells passing every filter in every\nmodality are retained. The filtered per-sample files are collected into a single output\ndirectory, and a single cell-count report covering every sample is written alongside it.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "dependencies" : [
    ...
    {
      "name" : "components/report/cell_count_report",
      "repository" : {
        "type" : "local"
      }
    }
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/src/workflows/processing/process_single_sample/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
