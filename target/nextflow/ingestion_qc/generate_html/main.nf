...
meta = [
  ...
  "engines" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          "type" : "docker",
          "run" : [
            "npm install -g pnpm@latest-10 \\\\\n&& cd /opt && git clone -b rework-spatial https://github.com/openpipelines-bio/incubator_ingestion_qc.git \\\\\n&& cd incubator_ingestion_qc && pnpm install \\\\\n&& true\n"
          ]
        }
      ]
    }
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/src/ingestion_qc/generate_html/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
