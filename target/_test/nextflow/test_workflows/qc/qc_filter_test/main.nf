...
meta = [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Path to the h5mu emitted by the QC sub-workflow.",
          "example" : [
            "output.h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          "type" : "string",
          "name" : "--modality",
          "description" : "The modality the QC sub-workflow operated on.",
          "example" : [
            "rna"
          ],
          "required" : true,
        ...
        {
          "type" : "string",
          "name" : "--keep_flag_columns",
          "description" : "Boolean keep-flag .obs columns (in the tested modality) that the workflow is expected\nto have written.\n",
          "example" : [
            "filter_counts_rna",
            "filter_quantile_rna"
          ],
  ...
  "description" : "Checks the output of the qc_filter_rna / qc_filter_prot integration tests. Verifies that the\nfilters ran in flag-only mode: the modality's cells and genes are left untouched (no\nsubsetting) and the expected boolean keep-flag columns were written to .obs.\n",
  "status" : "enabled",
  "scope" : {
    "image" : "test",
    "target" : "test"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/src/workflows/test_workflows/qc/qc_filter_test/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/target/_test/nextflow/test_workflows/qc/qc_filter_test",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'keep_flag_columns': $( if [ ! -z ${VIASH_PAR_KEEP_FLAG_COLUMNS+x} ]; then echo "r'${VIASH_PAR_KEEP_FLAG_COLUMNS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-hub/custom-singlecell/test_workflows/qc/qc_filter_test",
    "tag" : "build_main"
  },
  "label" : [
    "singlecpu",
