...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Expected sample id in the report. The workflow passes its event id as the sample-id\nfallback, so when the data carries no sample-id .obs column the report is grouped by\nthis id.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "Whether the workflow ran scrublet doublet detection, in which case the report is\nexpected to contain a scrublet stage column.\n",
          "direction" : "input"
        }
      ]
    }
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_incubator/openpipeline_incubator/src/workflows/test_workflows/processing/process_single_sample_test/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-hub/custom-singlecell/test_workflows/processing/process_single_sample_test",
    "tag" : "build_main"
  },
  "label" : [
    "singlecpu",
