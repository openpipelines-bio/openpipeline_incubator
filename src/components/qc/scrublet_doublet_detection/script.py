...
if par["obs_name_predicted_doublets"] is not None:
    data.obs[par["obs_name_predicted_doublets"]] = (
        np.nan if predicted_doublets is None else predicted_doublets
    )
    data.obs[par["obs_name_predicted_doublets"]] = data.obs[
        par["obs_name_predicted_doublets"]
